function [U, V,E] = kpmf_gd1(R, mask, D, K_u_inv, K_v_inv, sigma_r, eta,maxIters)
%
% Author: Tinghui Zhou, Hanhuai Shan & Seb Grubb
%
...
%     disp(['iter' ,int2str(numIters),', err=',num2str(err)]);
